...
<body>
  ...
  <div id="loginer">
    <div id="form">
      <fieldset>
        <legend id="page_title">&nbsp; 로그인 &nbsp;</legend>
          ...
          <form name = "join_form" action = "./join.php" method = "POST">
            <table align="center">
              ...
              <tr align="center">
                <td colspan="3" align=center><br><input type="button" id="btn_pwd_update" value="로그인" onclick="check()"></td>
              </tr>
              <tr>
                <td colspan="3" align-center><br><input type="button" id="btn_name_update" value="회원가입 페이지" name="back" onclick="location.href='signup.php'"></td>
              </tr>
              <br>
            </table>
          </form>
